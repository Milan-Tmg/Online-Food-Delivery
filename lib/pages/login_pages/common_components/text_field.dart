...
class TextField_ extends StatelessWidget {
  TextField_({super.key, required this.label, required this.visible, required this.text_controller});
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.symmetric(horizontal: App_size.app_width*0.02, vertical: App_size.app_height* 0.02),
      child: TextField(
        obscureText: visible,
